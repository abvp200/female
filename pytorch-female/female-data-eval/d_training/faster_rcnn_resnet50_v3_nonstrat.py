...
if __name__ == "__main__":
    ...
    for i in [0,1,2,3,4]:  #
        ...
        mlflow_logger = MLFlowLogger(
            experiment_name=f'FasterRCNN_ResNet50_Img32_ALL_CLS_DSet_v10__{split_type}_classesNo{num_classes}_ep1_1120x1120',
        ...
        model_name = f'resnet50_FINAL_v3.10_repeat{i}'

        
        weights ='ResNet50_Weights.IMAGENET1K_V2'
        
        checkpoint_name = f"{model_name}_{weights.replace('.','')}_{class_ids_str}_v10_1ep_1120x1120_augm_{split_type}_repeat{i}"
