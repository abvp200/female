    ...
    for cls in [0,1,2,3,4,5,6,7,8]:
        for i in [0,1,2,3,4]:
            ...
            mlflow_logger = MLFlowLogger(
                experiment_name=f'FasterRCNN_ResNet50_ImgV2_ALL_CLS_DSet_v4__{split_type}_classesNo{num_classes}_perClass{cls}',
            ...
            model_name =f'resnet50_FINAL_v2.4_repeat_perClass_{cls}_stratified'
