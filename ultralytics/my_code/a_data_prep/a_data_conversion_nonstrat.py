...
for split_no in [0,1,2,3,4]:
    ...
    # Define the paths
    root_src = f'/mnt/data_vilen/05_model_input/repeated_nonstratified_train_val_test_split/yolo_v6_all_classes_COCO_v4_noEmpty/repeated_split_{split_no}/'
    root_target = f'/mnt/data_vilen/05_model_input/repeated_nonstratified_train_val_test_split/ultralitics_all_classes_COCO_v4_noEmpty/repeated_split_{split_no}/'
    ...
    data_yml_content = f"""
# Train/val/test sets
path: /mnt/data_vilen/05_model_input/repeated_nonstratified_train_val_test_split/ultralitics_all_classes_COCO_v4_noEmpty/repeated_split_{split_no} # dataset root dir
