...
if __name__ == "__main__":
    ...
    for i in [3,4]:  # 0,1,2,3,4
        # Main script
        data_dir = f'/mnt/data_vilen/05_model_inwput/repeated_stratified_train_val_test_split/yolo_v6_all_classes_COCO_v4_noEmpty/repeated_split_{i}'
        num_classes = 9
