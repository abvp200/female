...
if __name__ == "__main__":
    ...
    for i in [0,1,2,3,4]:  #
        ...
        mlflow_logger = MLFlowLogger(
            experiment_name=f'FasterRCNN_resnet101_v7_1ep__ALL_CLS_DSet_{split_type}_classesNo{num_classes}',
        ...
        model_name = f'resnet101_FINALv4_v7_1ep_repeat{i}'
        weights ='ResNet101_Weights.IMAGENET1K_V1'
        
        checkpoint_name = f"{model_name}_{weights.replace('.','')}_{class_ids_str}_v4_v7_1ep__augm_{split_type}_repeat{i}"
