...
from transforms import ImageClassificationWithBBoxes
...
def get_transforms():
    return ImageClassificationWithBBoxes(crop_size=224, resize_size=232)
...
if __name__ == "__main__":
    ...
    for i in [0,1,2,3,4]:  #
        ...
        mlflow_logger = MLFlowLogger(
            experiment_name=f'FasterRCNN_ResNet50_ImgV2_ALL_CLS_DSet_v5__{split_type}_classesNo{num_classes}_ep1_640x640',
        ...
        model_name = f'resnet50_FINAL_v2.5_repeat{i}'
        weights ='ResNet50_Weights.IMAGENET1K_V2'
        
        checkpoint_name = f"{model_name}_{weights.replace('.','')}_{class_ids_str}_v5_1ep_640x640_no_augm_{split_type}_repeat{i}"
